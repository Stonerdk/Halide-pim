...
int gemv(struct halide_buffer_t *_weight_buffer, struct halide_buffer_t *_vector_buffer, struct halide_buffer_t *_gemv_buffer) {
 ...
 bool _44 = _halide_buffer_is_bounds_query(_weight_buffer);
 bool _45 = !(_44);
 int32_t _46 = ::halide_cpp_min(_27, 2048);
 int32_t _47 = _46 + _26;
 bool _48 = 2048 <= _47;
 int32_t _49 = _27 + _26;
 bool _50 = _49 <= 8192;
 ...
 if (!_52)
 {
  int32_t _53 = ::halide_cpp_min(_27, 2048);
  int32_t _54 = _53 + _26;
  int32_t _55 = _54 + -2048;
  int32_t _56 = _27 + _26;
  int32_t _57 = _56 + -1;
  int32_t _58 = halide_error_constraints_make_required_region_smaller(_ucon, "Input buffer weight", 1, 0, 8191, _55, _57);
  return _58;
 }
 bool _59 = _halide_buffer_is_bounds_query(_gemv_buffer);
 if (_59)
 {
  auto *_60 = _halide_buffer_get_shape(_gemv_buffer);
  auto *_61 = (void *)(nullptr);
  uint64_t _62 = (uint64_t)(0ull);
  auto *_63 = (struct halide_device_interface_t *)(nullptr);
  int32_t _64 = ::halide_cpp_min(_27, 2048);
  int32_t _65 = _64 + _26;
  int32_t _66 = _65 + -2048;
  int32_t _67 = ::halide_cpp_max(_27, 2048);
  struct halide_dimension_t s0[1] = {
   {_66, _67, 1, 0},
  };
  auto *_68 = s0;
  auto *_69 = _halide_buffer_init(_gemv_buffer, _60, _61, _62, _63, 0, 32, 1, _68, _62);
  halide_maybe_unused(_69);
 } // if _59
 bool _70 = _halide_buffer_is_bounds_query(_vector_buffer);
 if (_70)
 {
  auto *_71 = _halide_buffer_get_shape(_vector_buffer);
  auto *_72 = (void *)(nullptr);
  uint64_t _73 = (uint64_t)(0ull);
  auto *_74 = (struct halide_device_interface_t *)(nullptr);
  struct halide_dimension_t s1[1] = {
   {0, 4096, 1, 0},
  };
  auto *_75 = s1;
  auto *_76 = _halide_buffer_init(_vector_buffer, _71, _72, _73, _74, 0, 32, 1, _75, _73);
  halide_maybe_unused(_76);
 } // if _70
 bool _77 = _halide_buffer_is_bounds_query(_weight_buffer);
 if (_77)
 {
  auto *_78 = _halide_buffer_get_shape(_weight_buffer);
  auto *_79 = (void *)(nullptr);
  uint64_t _80 = (uint64_t)(0ull);
  auto *_81 = (struct halide_device_interface_t *)(nullptr);
  struct halide_dimension_t s2[2] = {
   {0, 4096, 1, 0},
   {0, 8192, 4096, 0},
  };
  auto *_82 = s2;
  auto *_83 = _halide_buffer_init(_weight_buffer, _78, _79, _80, _81, 0, 32, 2, _82, _80);
  halide_maybe_unused(_83);
 } // if _77
 bool _84 = _halide_buffer_is_bounds_query(_weight_buffer);
 bool _85 = _halide_buffer_is_bounds_query(_gemv_buffer);
 bool _86 = _halide_buffer_is_bounds_query(_vector_buffer);
 bool _87 = _85 || _86;
 bool _88 = _84 || _87;
 bool _89 = !(_88);
 if (_89)
 {
  uint32_t _90 = (uint32_t)(73728ull);
  bool _91 = _24 == _90;
  if (!_91)
  {
   uint32_t _92 = (uint32_t)(73728ull);
   int32_t _93 = halide_error_bad_type(_ucon, "Output buffer gemv", _24, _92);
   return _93;
  }
  bool _94 = _25 == 1;
  if (!_94)
  {
   int32_t _95 = halide_error_bad_dimensions(_ucon, "Output buffer gemv", _25, 1);
   return _95;
  }
  uint32_t _96 = (uint32_t)(73728ull);
  bool _97 = _30 == _96;
  if (!_97)
  {
   uint32_t _98 = (uint32_t)(73728ull);
   int32_t _99 = halide_error_bad_type(_ucon, "Input buffer vector", _30, _98);
   return _99;
  }
  bool _100 = _31 == 1;
  if (!_100)
  {
   int32_t _101 = halide_error_bad_dimensions(_ucon, "Input buffer vector", _31, 1);
   return _101;
  }
  uint32_t _102 = (uint32_t)(73728ull);
  bool _103 = _36 == _102;
  if (!_103)
  {
   uint32_t _104 = (uint32_t)(73728ull);
   int32_t _105 = halide_error_bad_type(_ucon, "Input buffer weight", _36, _104);
   return _105;
  }
  bool _106 = _37 == 2;
  if (!_106)
  {
   int32_t _107 = halide_error_bad_dimensions(_ucon, "Input buffer weight", _37, 2);
   return _107;
  }
  bool _108 = 2048 <= _27;
  if (!_108)
  {
   ...
   int32_t _110 = ::halide_cpp_min(_27, 2048);
   int32_t _111 = _110 + _26;
   int32_t _112 = _111 + -2048;
   int32_t _113 = _109 + -1;
   int32_t _114 = halide_error_access_out_of_bounds(_ucon, "Output buffer gemv", 0, _112, _113, _26, _113);
   return _114;
  }
  bool _115 = _32 <= 0;
  int32_t _116 = _33 + _32;
  bool _117 = 4096 <= _116;
  bool _118 = _115 && _117;
  if (!_118)
  {
   int32_t _119 = _33 + _32;
   int32_t _120 = _119 + -1;
   int32_t _121 = halide_error_access_out_of_bounds(_ucon, "Input buffer vector", 0, 0, 4095, _32, _120);
   return _121;
  }
  bool _122 = 0 <= _33;
  if (!_122)
  {
   int32_t _123 = halide_error_buffer_extents_negative(_ucon, "Input buffer vector", 0, _33);
   return _123;
  }
  bool _124 = _38 <= 0;
  int32_t _125 = _39 + _38;
  bool _126 = 4096 <= _125;
  bool _127 = _124 && _126;
  if (!_127)
  {
   int32_t _128 = _39 + _38;
   int32_t _129 = _128 + -1;
   int32_t _130 = halide_error_access_out_of_bounds(_ucon, "Input buffer weight", 0, 0, 4095, _38, _129);
   return _130;
  }
  bool _131 = 0 <= _39;
  if (!_131)
  {
   int32_t _132 = halide_error_buffer_extents_negative(_ucon, "Input buffer weight", 0, _39);
   return _132;
  }
  bool _133 = _41 <= _26;
  int32_t _134 = _27 + _26;
  int32_t _135 = _42 + _41;
  bool _136 = _134 <= _135;
  bool _137 = _133 && _136;
  if (!_137)
  {
   int32_t _138 = _27 + _26;
   int32_t _139 = _138 + -1;
   int32_t _140 = _42 + _41;
   int32_t _141 = _140 + -1;
   int32_t _142 = halide_error_access_out_of_bounds(_ucon, "Input buffer weight", 1, _26, _139, _41, _141);
   return _142;
  }
  bool _143 = 0 <= _42;
  if (!_143)
  {
   int32_t _144 = halide_error_buffer_extents_negative(_ucon, "Input buffer weight", 1, _42);
   return _144;
  }
  bool _145 = _28 == 1;
  if (!_145)
  {
   int32_t _146 = halide_error_constraint_violated(_ucon, "gemv.stride.0", _28, "1", 1);
   return _146;
  }
  bool _147 = _34 == 1;
  if (!_147)
  {
   int32_t _148 = halide_error_constraint_violated(_ucon, "vector.stride.0", _34, "1", 1);
   return _148;
  }
  bool _149 = _32 == 0;
  if (!_149)
  {
   int32_t _150 = halide_error_constraint_violated(_ucon, "vector.min.0", _32, "0", 0);
   return _150;
  }
  bool _151 = _33 == 4096;
  if (!_151)
  {
   int32_t _152 = halide_error_constraint_violated(_ucon, "vector.extent.0", _33, "4096", 4096);
   return _152;
  }
  bool _153 = _40 == 1;
  if (!_153)
  {
   int32_t _154 = halide_error_constraint_violated(_ucon, "weight.stride.0", _40, "1", 1);
   return _154;
  }
  bool _155 = _38 == 0;
  if (!_155)
  {
   int32_t _156 = halide_error_constraint_violated(_ucon, "weight.min.0", _38, "0", 0);
   return _156;
  }
  bool _157 = _39 == 4096;
  if (!_157)
  {
   int32_t _158 = halide_error_constraint_violated(_ucon, "weight.extent.0", _39, "4096", 4096);
   return _158;
  }
  bool _159 = _43 == 4096;
  if (!_159)
  {
   int32_t _160 = halide_error_constraint_violated(_ucon, "weight.stride.1", _43, "4096", 4096);
   return _160;
  }
  bool _161 = _41 == 0;
  if (!_161)
  {
   int32_t _162 = halide_error_constraint_violated(_ucon, "weight.min.1", _41, "0", 0);
   return _162;
  }
  bool _163 = _42 == 8192;
  if (!_163)
  {
   int32_t _164 = halide_error_constraint_violated(_ucon, "weight.extent.1", _42, "8192", 8192);
   return _164;
  }
  uint64_t _165 = (uint64_t)(_27);
  uint64_t _166 = (uint64_t)(2147483647ull);
  bool _167 = _165 <= _166;
  if (!_167)
  {
   uint64_t _168 = (uint64_t)(_27);
   uint64_t _169 = (uint64_t)(2147483647ull);
   int32_t _170 = halide_error_buffer_allocation_too_large(_ucon, "gemv", _168, _169);
   return _170;
  }
  // produce gemv
  int32_t _171 = _27 + 2047;
  int32_t _172 = _171 >> 11;
  int32_t _173 = halide_upmem_alloc_load(_172, "kernel_0");
  bool _174 = _173 == 0;
  if (!_174)
  {
   return _173;
  }
  // produce vector.copy_to
  int32_t _175 = _27 + 2047;
  int32_t _176 = _175 >> 11;
  for (int _gemv_s0_i_block___bank_id_x = 0; _gemv_s0_i_block___bank_id_x < 0 + _176; _gemv_s0_i_block___bank_id_x++)
  {
   int32_t _177 = halide_upmem_dpu_copy_to(_gemv_s0_i_block___bank_id_x, _vector_buffer, 0, 4096);
   halide_maybe_unused(_177);
  } // for _gemv_s0_i_block___bank_id_x
  // produce weight.copy_to
  int32_t _178 = _27 & 2047;
  bool _179 = _178 != 0;
  int32_t _180 = _27 >> 11;
  int32_t _181 = _27 + _26;
  for (int _ii1 = 0; _ii1 < 0 + 2048; _ii1++)
  {
   int32_t _182 = _26 + _ii1;
   for (int _gemv_s0_i_block___bank_id_x = 0; _gemv_s0_i_block___bank_id_x < 0 + _180; _gemv_s0_i_block___bank_id_x++)
   {
    int32_t _183 = _gemv_s0_i_block___bank_id_x * 2048;
    int32_t _184 = _183 + _182;
    int32_t _185 = _184 * 4096;
    int32_t _186 = halide_upmem_dpu_copy_to(_gemv_s0_i_block___bank_id_x, _weight_buffer, _185, 4096);
    halide_maybe_unused(_186);
   } // for _gemv_s0_i_block___bank_id_x
   if (_179)
   {
    int32_t _187 = _ii1 + _181;
    int32_t _188 = _187 * 4096;
    int32_t _189 = _188 + -8388608;
    int32_t _190 = halide_upmem_dpu_copy_to(_180, _weight_buffer, _189, 4096);
    halide_maybe_unused(_190);
   } // if _179
  } // for _ii1
  int32_t _191 = _27 + 2047;
  int32_t _192 = _191 >> 11;
  auto *_193 = ((void * *)_upmem)[0];
  uint32_t _194 = (uint32_t)(73728ull);
  uint32_t _195 = (uint32_t)(0ull);
  struct {
   uint32_t f_0;
   uint32_t f_1;
   uint32_t f_2;
  ...
  auto *_198 = (&s4);
  uint8_t _199 = (uint8_t)(1ull);
  uint8_t _200 = (uint8_t)(0ull);
  struct {
   uint8_t f_0;
   uint8_t f_1;
   uint8_t f_2;
  ...
  auto *_201 = (&s5);
  int32_t _202 = halide_upmem_run(_193, "_kernel_gemv_s0_i_block___bank_id_x", _192, 1, 1, 16, 0, _196, _198, _201);
  bool _203 = _202 == 0;
  if (!_203)
  {
   return _202;
  }
  // produce gemv.copy_from
  int32_t _204 = _27 >> 11;
  for (int _gemv_s0_i_block___bank_id_x = 0; _gemv_s0_i_block___bank_id_x < 0 + _204; _gemv_s0_i_block___bank_id_x++)
  {
   int32_t _205 = _gemv_s0_i_block___bank_id_x * 2048;
   int32_t _206 = _205 + _26;
   int32_t _207 = halide_upmem_dpu_copy_from(_gemv_s0_i_block___bank_id_x, _gemv_buffer, _206, 2048);
   halide_maybe_unused(_207);
  } // for _gemv_s0_i_block___bank_id_x
  int32_t _208 = _27 & 2047;
  bool _209 = _208 != 0;
  if (_209)
  {
   int32_t _210 = _27 >> 11;
   int32_t _211 = _27 + _26;
   int32_t _212 = _211 + -2048;
   int32_t _213 = halide_upmem_dpu_copy_from(_210, _gemv_buffer, _212, 2048);
   halide_maybe_unused(_213);
  } // if _209
  int32_t _214 = halide_upmem_free("kernel_0");
  bool _215 = _214 == 0;
  if (!_215)
  {
   return _214;
